...
public class AuctionTests {
	...
	public void simpleAuctionTest() {
		...
		for (int i=0; i<20; i++) {
			messages.addAll(sqs.receiveMessage(receiveRequest)
					.getMessages());
		...
		for (Message m : messages) {
            ...
            sqs.deleteMessage(new DeleteMessageRequest("AUCTION_BROADCAST_QUEUE", messageRecieptHandle));
		}
		//You cant assert that as messages will arrive in an uncertain order
